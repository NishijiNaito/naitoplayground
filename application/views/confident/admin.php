        ...
        <div class="card mb-3" style="font-size: 25px;">
            ...
            <div class="card-body text-center">
                ...
                <div class="row  mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="d-grid gap-2 mb-3">
                            <button type="button" onclick="show_Player_answer()" id="spa" class="btn btn-info">Show Player Answer</button>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="d-grid gap-2 mb-3">
                            <button type="button" onclick="Reveal_answer()" id="ra" class="btn btn-success" disabled>Reveal Answer</button>
                        </div>
